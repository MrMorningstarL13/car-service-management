        ...
        <div className="bg-white rounded-lg shadow-md border border-[rgba(189,198,103,0.3)] p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center">
                    ...
                    <div>
                        <p className="text-sm font-medium text-[rgba(84,67,67,1)]">{services.filter(el => el.id === appointment.serviceId).map(el => el.name)}</p>
                        <p className="text-xs text-[rgba(84,67,67,0.7)]">Service Name</p>
                    </div>
                </div>
            </div>
