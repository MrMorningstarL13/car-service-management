      ...
      <div className="p-6 border-b border-gray-200">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            disabled={appointment.status === "accepted" || appointment.status === "completed"}
          ...
          <button
            ...
            className="flex items-center space-x-1 px-3 py-1.5 bg-red-600 text-white text-sm rounded-md hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <X className="w-4 h-4" />
            <span>Deny</span>
          </button>
          ...
          <button
            ...
            disabled={appointment.status === "completed" || appointment.status === "denied"}
            className="flex items-center space-x-1 px-3 py-1.5 bg-gray-600 text-white text-sm rounded-md hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <CheckCircle className="w-4 h-4" />
