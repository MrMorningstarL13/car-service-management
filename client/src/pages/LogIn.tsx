...
export default function LogIn() {
    ...
    return (
        <div id="canvas-container" className="min-h-screen">
            {/* <Canvas>
                ...
                <div className="bg-primary rounded-xl p-4">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type="password" name="password" value={formData.password} onChange={handleChange} className="w-full py-2 px-3 rounded-md border border-secondary focus:border-tertiary text-contrast-primary focus:outline-none" />
                        </div>
                        <button
                            type="submit"
