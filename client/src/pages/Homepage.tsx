    ...
    export default function Home() {
        ...
        const { services, fetchShops, currentService, create, getById } = useServiceStore()
        ...
        useEffect(() => {
            ...
            if(currentUser.employee)
                getById(currentUser.employee.serviceId)
        ...
        }, [fetchShops, fetchCars, getByUser, getByService, fetchEmployees, getById])
        ...
        const handleUpdateAppointmentStatus = async(appointmentId: number, status: string) => {
            ...
            await update(String(appointmentId), updateBody)
            await getByService(currentUser.employee.serviceId)
